...
export declare class BankSyncService {
    ...
    constructor(bankTxModel: Model<BankTransactionDocument>, usersService: UsersService, obsWidgetGateway: OBSWidgetGateway, bankDonationTotalService: BankDonationTotalService, configService: ConfigService);
