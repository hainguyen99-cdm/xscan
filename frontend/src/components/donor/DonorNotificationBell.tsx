...
interface DonorNotificationBellProps {
  className?: string;
}

export default function DonorNotificationBell({ className = '' }: DonorNotificationBellProps) {
  ...
  // Fetch notifications and preferences on component mount
  useEffect(() => {
    fetchNotifications();
    fetchPreferences();
    fetchUnreadCount();
