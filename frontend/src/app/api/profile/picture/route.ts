...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('Attempting to upload to backend:', `${backendUrl}/api/users/profile/picture`);

    // Forward the request to the backend
    const backendResponse = await fetch(`${backendUrl}/api/users/profile/picture`, {
      method: 'POST',
      headers: {
